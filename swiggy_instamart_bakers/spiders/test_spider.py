...
#
#         # products_df = pd.read_excel(r'C:\Shalu\LiveProjects\swiggy_instamart_bakers\input_files\product.xlsx')
#         products_df = pd.read_excel(r'C:\Shalu\LiveProjects\swiggy_instamart_bakers\input_files\pro.xlsx')
#         folder_loc =  f'C:/Shalu/PageSave/swiggy_bakers/page_save_{today_date_time}/'
#
#         if not os.path.exists(folder_loc):
#             os.mkdir(folder_loc)
#
#         for product_id, sku_name, product_name,product_url,brand_name in zip(products_df['product_id'], products_df['sku_name'], products_df['product_name'], products_df['product_url'], products_df['brand_name']):
#
...
#                                     # 'cookie': 'deviceId=s%3A7e2e0ec6-5f0b-4d91-8a00-980ea139b346.V0wmqfDmmE%2BsX1Fe%2BB2gxZAjDyTWG8h3vWS0oIPshew; versionCode=1200; platform=web; subplatform=dweb; statusBarHeight=0; bottomOffset=0; genieTrackOn=false; isNative=false; openIMHP=false; webBottomBarHeight=0; _gcl_au=1.1.1811132046.1725435834; _fbp=fb.1.1725435834556.791108566446662169; addressId=s%3A.4Wx2Am9WLolnmzVcU32g6YaFDw0QbIBFRj2nkO7P25s; tid=s%3A666ea29d-dbca-49fb-9e92-6b9b49d20160.bG5gmG15jclEDAalCEfE7AfVZbdYeOY2UIOjODoeLgE; __SW=4Q7hU-il8VbCbtMn7UHRC628K6BSI4Ck; _device_id=4823160e-db14-88ce-ea30-bb2dc92a3e80; fontsLoaded=1; _gid=GA1.2.293315994.1725457358; dadl=true; _ga_8N8XRG907L=deleted; _guest_tid=f78edda6-8f75-4bf3-bda9-08cb7a0db4a3; _sid=fxo7e9c7-a1f0-4744-a55f-5000166fa4e4; _ga=GA1.1.819256061.1725435834; sid=s%3Afxo7e9c7-a1f0-4744-a55f-5000166fa4e4.ElaKhFPEiiGqdKnondNER2W3s02b77ncGRWeDpet%2Bdg; ally-on=false; strId=; lat=s%3A12.9566294.LJG1UGdHf7kBglmf%2FYV6wP%2BDXdYcHv93zwwesXZsHyo; lng=s%3A77.70468230000002.5PSQpTEGWmPKQkjYtNLbD65CSpKljnmb3fm72UKPjJg; address=s%3ABengaluru%2C%20Karnataka%20560037%2C%20India.JJQ%2F1q%2B559LoSYXJVH5emIq9i8hJ1Ma8jGesGn1Q9hE; LocSrc=s%3AswgyUL.Dzm1rLPIhJmB3Tl2Xs6141hVZS0ofGP7LGmLXgQOA7Y; userLocation=%7B%22address%22%3A%22Bengaluru%2C%20Karnataka%20560037%2C%20India%22%2C%22lat%22%3A12.9566294%2C%22lng%22%3A77.70468230000002%2C%22id%22%3A%22%22%2C%22annotation%22%3A%22%22%2C%22name%22%3A%22%22%7D; _ga_34JYJ0BCRN=GS1.1.1725520961.4.1.1725520992.0.0.0; _ga_8N8XRG907L=GS1.1.1725520994.7.1.1725521002.0.0.0',
#                                     'pragma': 'no-cache',
#                                     'priority': 'u=0, i',
...
#                             #     'userLocation':cookies['userLocation'],
...
#             sku_name=response.request.meta['sku_name']
#             if pd.isna(sku_name):
#                 sku_name=''
...
#             items['area'] = response.request.meta['area']  # input
#             items['city'] = response.request.meta['city']
#             items['productUrl'] = product_url
#             items['storeid'] =  ''# input
#             items['lat_long'] = ''
#             items['SkuName'] = sku_name  # input
#             items['productId'] = product_id  # input
#             items['BrandName'] = response.request.meta['brand_name']
#             items['productName'] = product_name  # input
#             items['productImage'] = ''
#             items['mrp'] = ''
#             items['productPrice'] = ''
#             items['discount'] = ''
